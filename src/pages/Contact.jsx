        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
          <div className="text-center">
            ...
            <p className="text-xl md:text-2xl mb-8 opacity-90">
              {data.content || "Get in touch with us for any inquiries"}
            </p>
          </div>
        </div>
      </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-6">
              {[
                { icon: "📍", title: "Address", content: "123 Beauty Street, Fashion District, City, State 12345" },
                { icon: "📞", title: "Phone", content: "+1 (555) 123-4567" },
                { icon: "✉️", title: "Email", content: "info@jajis.com" },
                { icon: "🕒", title: "Business Hours", content: "Mon-Sat: 9:00 AM - 8:00 PM, Sun: 10:00 AM - 6:00 PM" }
              ].map((info, index) => (
